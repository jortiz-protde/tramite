...
function enviarCorreoAsistentes($tramiteID, $nombre, $ruta, $cnx){
    ...
    Se remite la información del documento que acaba de firmarse por el Sistema STD</p><table class="spacer" style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
