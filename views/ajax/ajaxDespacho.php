...
switch ($_POST['Evento']){
    ...
    case 'CompletarDevolucion':
        ...
        $cuerpo = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                    ...
                    Se remite el cargo retornado a la APCI por mesa de partes a través del Sistema STD del documento : '.$nombreDoc.'</p><table class="spacer" style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
